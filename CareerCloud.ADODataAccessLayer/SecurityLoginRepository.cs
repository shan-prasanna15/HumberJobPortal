...
{
    public class SecurityLoginRepository : SystemCountryCodeRepository<SecurityLoginPoco>
    {
        ...
        public IList<SecurityLoginPoco> GetAll(params Expression<Func<SecurityLoginPoco, object>>[] navigationProperties)
        {
            ...
            while (rdr.Read())
            {
                ...
                poco.PasswordUpdate = rdr.IsDBNull(4) ? null : (DateTime?)rdr.GetValue(4);
                poco.AgreementAccepted = rdr.IsDBNull(5) ? null : (DateTime?)rdr.GetValue(5);
                poco.IsLocked =  rdr.GetBoolean(6);
                poco.IsInactive =  rdr.GetBoolean(7);
                poco.EmailAddress = rdr.GetString(8);
                poco.PhoneNumber = rdr.IsDBNull(9) ? null : (String?)rdr[9];
                poco.FullName = rdr.IsDBNull(10) ? null : (String?)rdr[10];
                poco.ForceChangePassword = rdr.GetBoolean(11);
                poco.PrefferredLanguage = rdr.IsDBNull(12) ? null : (String?)rdr[12];
                poco.TimeStamp = BitConverter.GetBytes(13);
